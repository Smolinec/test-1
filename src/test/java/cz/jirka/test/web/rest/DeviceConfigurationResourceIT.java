...
public class DeviceConfigurationResourceIT {
     ...
     *
     * @see cz.jirka.test.repository.search.DeviceConfigurationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateDeviceConfiguration() throws Exception {
        ...
        // Validate the DeviceConfiguration in Elasticsearch
        verify(mockDeviceConfigurationSearchRepository, times(2)).save(testDeviceConfiguration);
    }
