...
public class SMSNotificationResourceIT {
     ...
     *
     * @see cz.jirka.test.repository.search.SMSNotificationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateSMSNotification() throws Exception {
        ...
        // Validate the SMSNotification in Elasticsearch
        verify(mockSMSNotificationSearchRepository, times(2)).save(testSMSNotification);
    }
