...
public class PushNotificationTokenResourceIT {
    ...
    /**
     * This repository is mocked in the cz.jirka.test.repository.search test package.
     *
     * @see cz.jirka.test.repository.search.PushNotificationTokenSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updatePushNotificationToken() throws Exception {
        ...
        // Validate the PushNotificationToken in Elasticsearch
        verify(mockPushNotificationTokenSearchRepository, times(2)).save(testPushNotificationToken);
    }
