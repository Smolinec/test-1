...
public class DeviceProfileResourceIT {
     ...
     *
     * @see cz.jirka.test.repository.search.DeviceProfileSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateDeviceProfile() throws Exception {
        ...
        // Validate the DeviceProfile in Elasticsearch
        verify(mockDeviceProfileSearchRepository, times(2)).save(testDeviceProfile);
    }
